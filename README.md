# <p align="center"><img src="assets/logo.png" width="130" alt="WeatherGPT Logo" /><br/><br/><strong>WeatherGPT</strong></p>
...
<p align="center">
  <a href="https://github.com/Ismit-06/Weather_GPT/releases"><img src="https://img.shields.io/github/v/release/Ismit-06/Weather_GPT?color=00D2FF&label=Latest%20Release&style=for-the-badge&logo=android" alt="Latest Release" /></a>
  <a href="https://weather-gpt-ymze.onrender.com"><img src="https://img.shields.io/badge/Render%20Cloud-Online-00E676?style=for-the-badge&logo=fastapi" alt="API Status" /></a>
  <a href="#-instant-download--quick-installation"><img src="https://img.shields.io/badge/Platform-Android%208.0%2B-3DDC84?style=for-the-badge&logo=android" alt="Platform" /></a>
  <a href="#-license"><img src="https://img.shields.io/badge/License-MIT-38BDF8?style=for-the-badge" alt="License" /></a>
  <a href="https://github.com/Ismit-06/Weather_GPT/stargazers"><img src="https://img.shields.io/github/stars/Ismit-06/Weather_GPT?style=for-the-badge&color=F59E0B" alt="Stars" /></a>
</p>

<p align="center">
  <img src="assets/weather_ai_orb.svg" width="100%" alt="WeatherAI Orb Interactive Animated Banner" />
</p>
...
<p align="center">
  <a href="assets/app_mockup_showcase.png">
    <img src="assets/app_mockup_showcase.png" width="100%" alt="WeatherGPT Real Android App Interface: Home, Forecast, Voice Chat, Sky Vision, Turbo Map, Safety Center, CWC Dam Reports" style="border-radius: 16px; box-shadow: 0 10px 40px rgba(0,0,0,0.6);" />
  </a>
</p>
...
| :---: | :---: | :---: | :---: |
| <a href="assets/screenshots/01_home.png"><img src="assets/screenshots/01_home.png" width="180" alt="Home Dashboard" /></a> | <a href="assets/screenshots/02_forecast.png"><img src="assets/screenshots/02_forecast.png" width="180" alt="Forecast & Temperature Trend" /></a> | <a href="assets/screenshots/03_chat.png"><img src="assets/screenshots/03_chat.png" width="180" alt="Ask WeatherGPT Voice Assistant" /></a> | <a href="assets/screenshots/04_sky_ai.png"><img src="assets/screenshots/04_sky_ai.png" width="180" alt="Sky AI Camera Perception" /></a> |
...
| :---: | :---: | :---: |
| <a href="assets/screenshots/05_map.png"><img src="assets/screenshots/05_map.png" width="180" alt="Turbo Map & Radar Layers" /></a> | <a href="assets/screenshots/06_alerts.png"><img src="assets/screenshots/06_alerts.png" width="180" alt="Weather Safety Center Alerts" /></a> | <a href="assets/screenshots/07_dams.png"><img src="assets/screenshots/07_dams.png" width="180" alt="CWC Dam Flood Intelligence" /></a> |
...
```mermaid
graph TD
    subgraph EdgeClient ["📱 Android Client (Jetpack Compose & Material 3)"]
        UI["🎨 Glassmorphic Dynamic UI & WeatherAI Orb"]
        Cam["📸 CameraX Sky Vision Analyzer"]
        Audio["🎙️ Voice Pipeline & Audio Recorder"]
        Cache["💾 SQLite & Room Offline Cache"]
    end

    subgraph Gateway ["☁️ Cloud API & Telemetry Gateway (Render)"]
        FastAPI["⚡ FastAPI Async Engine"]
        WS["🔁 Bi-directional WebSocket Voice Stream"]
    end
    ...
    subgraph Intelligence ["🧠 Atmospheric AI & Scientific Fusion"]
        ...
        Doppler["📡 Doppler Radar & High-Res Met Models"]
    end
